...
class Main
{
	public static void main(String[] args) {
        ...
        sortArray.printArray(arr);
        //In this question we can solve the first question by counting the no of zeroes and then filled the array by 0 relatively and remaining with ones but For better TC and understanding 
	}
}